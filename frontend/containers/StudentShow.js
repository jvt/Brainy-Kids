				...
				<PageFormat page="users" title={user.name}>
					...
					<Row
						...
						<Col xs={8} style={{ textAlign: 'center' }}>
							...
							<Progress
								type="dashboard"
								percent={user.assignemntCompleted}
								status={
									user.assignemntCompleted === 100
										? `success`
										: 'active'
								}
						...
						<Col xs={8} style={{ textAlign: 'center' }}>
							...
							<Progress
								type="dashboard"
								percent={user.phonicsCompletion}
								status={
									user.phonicsCompletion === 100
										? `success`
										: 'active'
								}
								format={percent => `${percent}%`}
						...
						<Col xs={8} style={{ textAlign: 'center' }}>
							...
							<Progress
								type="dashboard"
								percent={user.rhymeAZooCompletion}
								status={
									user.rhymeAZooCompletion === 100
										? `success`
										: 'active'
								}
								format={percent => `${percent}%`}
					...
					<Row
						...
						<Col xs={24}>
							<h3>Problem Areas</h3>
							<p>
								<Icon type="warning" />&nbsp;Took <b>9 times</b>{' '}
								to complete a <b>Phonics</b> assignment
							</p>
							<p>
								<Icon type="exclamation-circle-o" />&nbsp;<b>
									Rhyme a Zoo
								</b>{' '}
								assignment took <b>30 minutes</b> to complete
							</p>
						</Col>
					</Row>
				</PageFormat>
